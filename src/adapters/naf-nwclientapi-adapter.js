let mediasoupClient = require('mediasoup-client');
let protooClient = require('protoo-client');
let newDebug = require("debug");
...
const debug = newDebug("naf-nwclientapi-adapter:debug");
//const warn = newDebug("naf-dialog-adapter:warn");
const error = newDebug("naf-nwclientapi-adapter:error");
const info = newDebug("naf-nwclientapi-adapter:info");

const PC_PROPRIETARY_CONSTRAINTS = {
  optional: [{ googDscp: true }]
};

class NWClientAPIAdapter {
  constructor() {
